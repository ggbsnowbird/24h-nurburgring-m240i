export default {
  title: "24h Nürburgring 2026 — M240i (polish)",
  root: "src",
  base: "/24h-nurburgring-m240i/polish/",
  pages: [
    { name: "Overview", path: "/" },
...
<style>
  ...
  header: `<div style="display:flex;align-items:center;gap:10px;padding:6px 0">
    ...
    <span style="opacity:0.4;font-size:0.82em;font-family:'Roboto Condensed',sans-serif">M240i Racing Cup · 2026 · polish</span>
  </div>`,
  footer: "Data: ADAC Sector Times PDF + LiveTiming WebSocket · Outlaps excluded · Laps >11:30 filtered · Polish design preview",
};
