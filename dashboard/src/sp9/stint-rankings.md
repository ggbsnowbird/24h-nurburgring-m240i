---
title: Stint Rankings — SP9
---

```js
const ranking     = await FileAttachment("../data/sp9/ranking.json").json();
const stints      = await FileAttachment("../data/sp9/stints.json").json();
const corrections = await FileAttachment("../data/sp9/corrections.json").json();
```
...
<div class="page-hero">
  ...
  <p class="page-pitch">Best lap & average pace, compared to every SP9 / GT3 driver on track in the same time window.</p>
</div>
